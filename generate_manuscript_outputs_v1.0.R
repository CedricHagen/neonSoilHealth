#!/usr/bin/env Rscript
# ============================================================================
# NEON PLFA Dataset - Manuscript Output Generation Script (FINAL)
# ============================================================================
# Final updates:
# - Figure 1a: Extended to show Canada and Mexico, fixed legend margins
# - All figures: Removed titles (journals add those in captions)
# - Figure 3: Fixed label placement, ensured no cutoff
# - Figure 6: Added R², p-values, N to all panels
# ============================================================================
...
# ============================================================================
# CALCULATE GRAM-POSITIVE:GRAM-NEGATIVE RATIO
# ============================================================================

cat("\n=== Calculating Gram-positive:Gram-negative ratio ===\n")

# Gram-positive bacteria (branched fatty acids)
...
# Gram-negative bacteria (monounsaturated fatty acids)
neon_plfa$gram_negative <- rowSums(neon_plfa[, c(
  "c16To1n7ScaledConcentration",
  "c18To1n11ScaledConcentration"
)], na.rm = TRUE)

# Calculate GP:GN ratio (set to NA where denominator is 0)
...
# ============================================================================
# CLEAN DATASET (Remove chemistry columns)
# ============================================================================
...
# ============================================================================
# GENERATE ALL TABLES (same as before)
# ============================================================================
...
# ============================================================================
# FIGURE GENERATION (FINAL VERSION)
# ============================================================================
...
# ----------------------------------------------------------------------------
# FIGURE 1A: IMPROVED MAP (includes Canada, Mexico, AK, HI, PR)
# ----------------------------------------------------------------------------
...
# Create map with proper extent and margins
fig1a <- ggplot() +
...
# ----------------------------------------------------------------------------
# FIGURE 1B & 1C: Temporal coverage and horizons (no titles)
# ----------------------------------------------------------------------------
...
# ----------------------------------------------------------------------------
# FIGURE 2: Distributions (no titles)
# ----------------------------------------------------------------------------
...
# ----------------------------------------------------------------------------
# FIGURE 3: LATITUDINAL GRADIENTS (with stats, no titles, fixed placement)
# ----------------------------------------------------------------------------
...
# Function to add stats annotation
...
# Panel C: Stress vs Latitude (with better label placement)
...
# ----------------------------------------------------------------------------
# FIGURE 4: DOMAIN PATTERNS (no titles)
# ----------------------------------------------------------------------------
...
# ----------------------------------------------------------------------------
# FIGURE 5: DATA QUALITY (no titles)
# ----------------------------------------------------------------------------
...
# Calculate temporal stability for sites with multi-year data
# Site-year means
...
# Calculate CV for sites with ≥3 years of data
...
# Save temporal stability statistics
...
# Using one-way random effects model: variance between sites / total variance
...
# Create Figure 5b: Temporal stability visualization
...
# ----------------------------------------------------------------------------
# FIGURE 6: PLFA RELATIONSHIPS (WITH STATS!)
# ----------------------------------------------------------------------------

cat("Generating Figure 6: PLFA Metric Relationships with statistics...\n")

# Function to get stats for annotation
...
# Panel B: Fungal vs Bacterial PLFA
...
# Panel C: Stress index vs F:B ratio
...
cat("\n")
cat("============================================================================\n")
cat("               FINAL MANUSCRIPT OUTPUTS COMPLETE\n")
cat("============================================================================\n")
cat("\n")
cat("Final Polish Applied:\n")
cat("  • Figure 1a: Extended map shows Canada, Mexico, AK, HI, PR\n")
cat("  • Figure 1a: Fixed legend margins (no cutoff)\n")
cat("  • All figures: Titles removed (added to captions only)\n")
cat("  • Figure 3: Fixed label placement (no cutoff)\n")
cat("  • Figure 6: Added R², p-values, N to all panels\n")
cat("\n")
cat("Dataset: 47 sites, 11,399 samples, 2017-2024\n")
cat("\n")
cat("ALL OUTPUTS READY FOR MANUSCRIPT SUBMISSION\n")
cat("============================================================================\n")
